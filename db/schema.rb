...
ActiveRecord::Schema.define(version: 20160412225551) do
  ...
  add_index "campaign_qualifications", ["campaign_quota_id"], name: "index_campaign_qualifications_on_campaign_quota_id", using: :btree
  ...
  add_index "campaign_quotas", ["campaign_id"], name: "index_campaign_quotas_on_campaign_id", using: :btree
